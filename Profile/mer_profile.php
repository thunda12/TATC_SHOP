<?php 
    ...
    if(isset($_SESSION['mer_id'])){
        $id = isset($_SESSION['mer_id'])?$_SESSION['mer_id'] :"";
        if($id != ""){
            $sql = "SELECT * FROM merchant WHERE mer_Id = $id";
...
<div class="profile">
<div class="container ">
    <h1>Hello Welcome : <span class="text-primary"><?php echo $_SESSION['mer_name'] ?></span></h1>
    <form action="mer_profile_edit.php?ID_mer=<?php echo $row['mer_Id']?>" method="POST">
        <div class="mb-3 ">
            ...
            <input name="card" type="text" class="form-control" value="<?php echo $row['merIdCard']?>">
        </div>
        <div class="input-group">
            <div class="mb-3 "style="width: 50% ;">
                <label for="exampleInputEmail1" class="form-label">ชื่อ</label>
                <input name="f_name" type="text" class="form-control" value="<?php echo $row['merFirstName']?>" style="width: 98%;">
            </div>
            <div class="mb-3 " style="width: 50% ;" >
                <label for="exampleInputEmail1" class="form-label">นามสกุล</label>
                <input name="l_name" type="text" class="form-control" value="<?php echo $row['merLastName']?>" style="width: 100%;">
            </div>
        </div>
        <div class="mb-3 ">
        ...
        <div class="mb-3">
            <label  class="form-label">อัพเกรดร้านค้า</label>
            <label  class="form-label">สามารถติดต่อได้ที่ 061-794-2338</label>
