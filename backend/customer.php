...
<section class="content-header">
  <div class="container-fluid"> 
    <h1><i class="nav-icon fas fa-address-card"></i> จัดการข้อมูลลูกค้า</h1>
    </div><!-- /.container-fluid -->
  </section>
  <!-- Main content -->
            ...
            <table id="example1" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info">
              <thead>
                ...
                <th  tabindex="0" rowspan="1" colspan="1" style="width: 7%;">รหัสลูกค้า</th>
                  ...
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 15%;">Tel .</th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 15%;">Username</th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 12%;">Password</th>
                  <th  tabindex="0" rowspan="1" colspan="1" style="width: 15%;">Address</th>
              ...
              <?php
                ...
                ?>
                    <tr>
                      ...
                      <td><?php echo $row['cusPassword'] ?></td>
                      <td><?php echo $row['address'] ?></td>
                      
                      <td>           
                        <a class="btn btn-warning btn-xs" href="edit_customer.php?id=<?php echo $row['cus_Id']?>" >
                          <i class="fas fa-pencil-alt">
                          </i>
                        </a>
                        <a class="btn btn-danger btn-xs" href="del_customer.php?id=<?php echo $row['cus_Id']?>">
