<?php 
    ...
    if(isset($_REQUEST['Register'])){
        ...
        if(count($errors)==0){
            ...
            $querySQL = "INSERT INTO customer(cusIdCard,phoneNumber,Email,cusPassword)
...
?>
    ...
    <style>
        body {
        background: rgb(255,193,131) repeat;
        background: linear-gradient(121deg, rgba(255,193,131,1) 35%, rgba(255,115,0,0.9413515406162465) 100%) repeat;
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            <div class="mb-md-5 mt-md-4 pb-5">
              <h2 class="fw-bold mb-2 text-uppercase text-white">สมัครเป็น ลูกค้า</h2>
